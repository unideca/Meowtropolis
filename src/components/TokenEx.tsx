            ...
            <Flex mx="auto" mt={56}>
                <Flex pl="40px" alignItems="center">                  
                    <Flex w="full" justifyContent="center">
                        ...
                        />
                        <Text w={["320px","400px","400px","400px","400px","400px","400px"]} fontSize={["32px","32px","32px","32px","32px","40px","40px"]} fontWeight="bold" color="teal.100">
                        metropolis-building cats dominating the meme coin world with charm and ambition!
                        </Text>
                        ...
                        <Button
                            ...
                            fontWeight="bold"
                            as="a" //down
                            href="/documents/Meowtropolis_Whitepaper_eng.pdf" //down
                            download="Meowtropolis_Whitepaper_eng.pdf" // 다운로드 속성 추가
