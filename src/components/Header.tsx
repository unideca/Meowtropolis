...
const Header : FC<HeaderProps> = ({tokenHomeRef, tokenServiceRef, tokenAboutRef, tokenRef, tokenRoadmapRef, contactRef }) => {
    ...
    return (
        ...
        <Flex
            ...
            bgColor={isScrolled ? "gray.800" : "transparent"}
            alignItems="center"
            justifyContent="space-between"
            zIndex={4} // 아래로 넘어갈 때 글자 안보임
        >
            <Flex alignItems="center" color="teal.400" position="relative"
            as="a"
            href="/" >
                <Img w="70px" src="images/meowlogo.png" zIndex={4}/>
                <Text w="160px" fontSize="24px" position="absolute" left="92px" top="20px">MeowTropolis</Text>
            </Flex>
