            ...
            >
                <Grid templateColumns={['repeat(1,1fr)','repeat(1,1fr)','repeat(1,1fr)','repeat(1,1fr)','repeat(1,1fr)','repeat(1,1fr)','repeat(1,1fr)']} w={["330px","330px","780px","1000px","1000px","1000px","1000px"]} mx="auto" id="aboutMid" gap="20px">
                    <Flex justifyContent="center">
                        <Img w="80%" src="images/meowtro.webp"/>
                    </Flex>
                    <Flex flexDir="column" justifyContent="center" alignItems="center">
                        <Text fontSize="18px">The management and trading of meme coins have become a transformative force in the modern financial system,
                            with meme-driven blockchain technology leading the charge of innovation. Among these groundbreaking projects is
                            MeowTropolis (MEWTRO Token). MeowTropolis envisions a world where adorable and cunning cats build a sprawling
                            metropolis, growing their influence and power in the digital meme ecosystem.
                        </Text>
                        {/* <Button
