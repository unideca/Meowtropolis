          ...
          <Flex textAlign="center" p={10} justifyContent="center" alignItems="center" maxW="1200px">
            <Flex h="680px" gap={2} alignItems="center" justifyContent="center" flexDir="column">
              <Flex
                ...
                mx="auto"
              >
                <Text fontSize={["20px","20px","20px","24px","24px","24px","24px"]} fontWeight="bold" color="teal.100">
                  Getting Started
                </Text>
                <Box textAlign="center" bg="gray.600" borderRadius="md" p={2} border="2px solid transparent" _hover={{borderColor: "white", cursor: "pointer"}} >
                  <Text
                    bg="#FFD700"
                    color="black"
                    fontSize="18px"
                  ...
                  <Text color="teal.100" fontSize={["16px","16px","16px","20px","20px","20px","20px"]} fontWeight="bold" mb={1}>
                    Choose your wallet
                  </Text>
                  <Text color="teal.100" fontSize={["14px","14px","14px","16px","16px","16px","16px"]} mb={2} >
                    A wallet is necessary for people wanting to use, trade, or hold MeowTropolis. You can pick a wallet.
                  </Text>
                </Box>
                <Box textAlign="center" bg="gray.600" borderRadius="md" p={2} border="2px solid transparent" _hover={{borderColor: "white", cursor: "pointer"}} >
                  <Text
                ...
                <Box textAlign="center" bg="gray.600" borderRadius="md" p={2} border="2px solid transparent" _hover={{borderColor: "white", cursor: "pointer"}}>
                  ...
                  <Text color="teal.100" fontSize={["14px","14px","14px","16px","16px","16px","16px"]} mb={2}>
                    There’s lots of ways to get your hands on some MEWTRO
                  </Text>
                </Box>
              </Flex>
              <Flex w={["90%","90%","90%","0","0","0","0"]} h="50%" justifyContent="center" mt={6}>
                <Img w="80%" h="100%" src="images/meowtokenex.webp"/>
              </Flex>
            </Flex>
